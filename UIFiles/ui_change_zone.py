...
class Ui_ZoneChanging(object):
    def setupUi(self, ZoneChanging):
        if not ZoneChanging.objectName():
            ZoneChanging.setObjectName(u"ZoneChanging")
        ZoneChanging.resize(614, 348)
        ZoneChanging.setStyleSheet(u"background-color: qlineargradient(spread:pad, x1:1, y1:1, x2:0, y2:0, stop:0 rgba(81, 0, 135, 255), stop:0.427447 rgba(41, 61, 132, 235), stop:1 rgba(155, 79, 165, 255));")
        self.gridLayout_3 = QGridLayout(ZoneChanging)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.tabWidget = QTabWidget(ZoneChanging)
...
"border: none")
        self.lbl_description.setTextFormat(Qt.TextFormat.AutoText)
...
"}")
        ...
        self.retranslateUi(ZoneChanging)

        self.tabWidget.setCurrentIndex(0)


        QMetaObject.connectSlotsByName(ZoneChanging)
    # setupUi

    def retranslateUi(self, ZoneChanging):
        ZoneChanging.setWindowTitle(QCoreApplication.translate("ZoneChanging", u"\u0418\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u0435 \u043f\u0430\u0440\u0430\u043c\u0435\u0442\u0440\u043e\u0432 \u0437\u043e\u043d\u044b", None))
        self.lbl_description.setText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u044f \u043a\u043e\u043e\u0440\u0434\u0438\u043d\u0430\u0442 \u0434\u043b\u044f \u043a\u0430\u0436\u0434\u043e\u0433\u043e \u0443\u0433\u043b\u0430 \u0437\u043e\u043d\u044b\n"
"\u0437\u043d\u0430\u0447\u0435\u043d\u0438\u044f \u0434\u043e\u043b\u0436\u043d\u044b \u0431\u044b\u0442\u044c \u0446\u0435\u043b\u044b\u043c\u0438 \u0447\u0438\u0441\u043b\u0430\u043c\u0438 \n"
"                     0 < x < 1280   0 < y < 720 ", None))
        self.le_left_top_cords.setText("")
        self.le_left_top_cords.setPlaceholderText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0447\u0435\u0440\u0435\u0437 \u043f\u0440\u043e\u0431\u0435\u043b", None))
        self.le_right_top_cords.setText("")
        self.le_right_top_cords.setPlaceholderText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0447\u0435\u0440\u0435\u0437 \u043f\u0440\u043e\u0431\u0435\u043b", None))
        self.le_left_bottom_cords.setText("")
        self.le_left_bottom_cords.setPlaceholderText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0447\u0435\u0440\u0435\u0437 \u043f\u0440\u043e\u0431\u0435\u043b", None))
        self.le_right_bottom_cords.setText("")
        self.le_right_bottom_cords.setPlaceholderText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0447\u0435\u0440\u0435\u0437 \u043f\u0440\u043e\u0431\u0435\u043b", None))
        self.lbl_right_top.setText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435 \u043a\u043e\u043e\u0440\u0434\u0438\u043d\u0430\u0442\n"
"\u043f\u0440\u0430\u0432\u043e\u0433\u043e \u0432\u0435\u0440\u0445\u043d\u0435\u0433\u043e \u0443\u0433\u043b\u0430 \u0437\u043e\u043d\u044b", None))
        self.lbl_left_top.setText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435 \u043a\u043e\u043e\u0440\u0434\u0438\u043d\u0430\u0442\n"
"\u043b\u0435\u0432\u043e\u0433\u043e \u0432\u0435\u0440\u0445\u043d\u0435\u0433\u043e \u0443\u0433\u043b\u0430 \u0437\u043e\u043d\u044b", None))
        self.lbl_left_bottom.setText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435 \u043a\u043e\u043e\u0440\u0434\u0438\u043d\u0430\u0442\n"
"\u043b\u0435\u0432\u043e\u0433\u043e \u043d\u0438\u0436\u043d\u0435\u0433\u043e \u0443\u0433\u043b\u0430 \u0437\u043e\u043d\u044b", None))
        self.lbl_right_bottom.setText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u0435 \u043a\u043e\u043e\u0440\u0434\u0438\u043d\u0430\u0442\n"
"\u043f\u0440\u0430\u0432\u043e\u0433\u043e \u043d\u0438\u0436\u043d\u0435\u0433\u043e \u0443\u0433\u043b\u0430 \u0437\u043e\u043d\u044b", None))
        self.btn_save_zone.setText(QCoreApplication.translate("ZoneChanging", u"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.zone_tab), QCoreApplication.translate("ZoneChanging", u"\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438 \u0437\u043e\u043d\u0438\u0440\u043e\u0432\u0430\u043d\u0438\u044f", None))
        self.lbl_sender.setText(QCoreApplication.translate("ZoneChanging", u"\u041f\u043e\u0447\u0442\u0430, \u0441 \u043a\u043e\u0442\u043e\u0440\u043e\u0439\n"
"\u0431\u0443\u0434\u0443\u0442 \u043f\u0440\u0438\u0445\u043e\u0434\u0438\u0442\u044c\n"
"\u0443\u0432\u0435\u0434\u043e\u043c\u043b\u0435\u043d\u0438\u044f:", None))
        self.le_sender_email.setText(QCoreApplication.translate("ZoneChanging", u"zone.monitor.alert@gmail.com", None))
        self.le_sender_email.setPlaceholderText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0430\u0434\u0440\u0435\u0441 \u043f\u043e\u0447\u0442\u044b", None))
        self.le_sender_pass.setText(QCoreApplication.translate("ZoneChanging", u"G7rB!x2#VpQ8^yM0", None))
        self.le_sender_pass.setPlaceholderText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u043f\u0430\u0440\u043e\u043b\u044c", None))
        self.btn_save_sender.setText(QCoreApplication.translate("ZoneChanging", u"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c", None))
        self.lbl_reciever.setText(QCoreApplication.translate("ZoneChanging", u"\u041f\u043e\u0447\u0442\u0430, \u043a\u0443\u0434\u0430\n"
"\u0431\u0443\u0434\u0443\u0442 \u043f\u0440\u0438\u0445\u043e\u0434\u0438\u0442\u044c\n"
"\u0443\u0432\u0435\u0434\u043e\u043c\u043b\u0435\u043d\u0438\u044f:", None))
        self.le_email_reciever.setPlaceholderText(QCoreApplication.translate("ZoneChanging", u"\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0430\u0434\u0440\u0435\u0441 \u043f\u043e\u0447\u0442\u044b", None))
        self.btn_save_reciever.setText(QCoreApplication.translate("ZoneChanging", u"\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.oth_settings_tab), QCoreApplication.translate("ZoneChanging", u"\u041e\u0441\u0442\u0430\u043b\u044c\u043d\u044b\u0435 \u043d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438", None))
    # retranslateUi
